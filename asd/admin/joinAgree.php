...
<body class="gray">
            ...
            <div class="container">
                ...
                <div class="join__agree">
                    <div>
                        ...
                        <p class="agremsg1" style="color:red"></p>
                        <div class="check">
                    ...
                    <div class="mt60">
                        ...
                        <p class="agremsg2" style="color:red"></p>
                        <div class="check">
                            <input type="checkbox" id="agreeCheck2" class="agreeCheck">
                            <label for="agreeCheck2">개인정보 수집 및 이용에 동의합니다. </label>
                        </div>
                    </div>
                    <div class="a__box" style="text-align:center">
                        <a style="display:inline-block" class="btnStyle a__click">동의</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        // 체크 표시 검사
        const aClick = document.querySelector(".a__click");
        const agreeCheck1 = document.querySelector("#agreeCheck1");
        const agreeCheck2 = document.querySelector("#agreeCheck2");
        const agreeMsg1 = document.querySelector(".agremsg1");
        const agreeMsg2 = document.querySelector(".agremsg2");

        aClick.addEventListener("click", (e) => {
            // e.preventDefault();

            if(agreeCheck1.checked == false) {
                agreeMsg1.innerText = "이용약관에 체크를 해주세요.";
            }
            if(agreeCheck1.checked == true) {
                agreeMsg1.innerText = "";
            }
            if(agreeCheck2.checked == false) {
                agreeMsg2.innerText = "개인정보에 체크를 해주세요.";
            }
            if(agreeCheck2.checked == true){
                agreeMsg2.innerText = "";
            }
            if(agreeCheck1.checked == true && agreeCheck2.checked == true){
                agreeMsg1.innerText = "";
                agreeMsg2.innerText = "";
                aClick.setAttribute("href", "joinSave.php");
            }
        });
    </script>
</body>
