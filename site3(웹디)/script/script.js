$(function(){
    ...
    // 슬라이드
    // let currentIndex = 0;
    // const $slideWrap = $(".sliderWrap");   // 이미지 부모 : 움직이는 영역
    // const $slider = $(".slider");          // 각각의 이미지
    // const $sliderWidth = $slider.width();  // 이미지 가로값

    // $slideWrap.append($slider.first().clone(true));    //첫번째 이미지를 복사 마지막에 추가

    // setInterval(function() {
    //     currentIndex++;     //현재 이미지를 1씩 증가
    //     $slideWrap.animate({marginLeft: -$sliderWidth * currentIndex}, 600);
